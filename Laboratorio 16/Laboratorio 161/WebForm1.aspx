...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="t" runat="server" Style="margin-left: 50px; margin-top: 24px;" Width="335px" Height="41px"></asp:TextBox>
            ...
            <asp:Button ID="b3" Text="3" runat="server" Height="37px" style="margin-left: 0px" Width="57px" OnClick="b3_Click" /> <asp:Button ID="add" Text="+" runat="server" Height="37px" style="margin-left: 0px;
            ...
            <asp:Button ID="b7" Text="7" runat="server" Height="37px" style="margin-left: 0px" Width="57px" OnClick="sub_Click" /> <asp:Button ID="Button2" Text="7" runat="server" Height="37px" style="margin-left: 0px"
